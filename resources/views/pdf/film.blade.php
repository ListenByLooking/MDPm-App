    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <table class="object-table">
                ...
                <tr>
                    <td class="label">Film Brand</td>
                    <td class="value">{{ $data->film_brand }}</td>
                </tr>

                <tr>
                    <td class="label">Carter Brand</td>
                    <td class="value">{{ $data->carter_brand }}</td>
                </tr>
                ...
                <tr>
                    <td class="label">Cement Splices</td>
                    <td class="value">{{ $data->cement_splices }}</td>
                </tr>

                <tr>
                    <td class="label">Restored Cement Splices</td>
                    <td class="value">{{ $data->restored_cs }}</td>
                </tr>

                <tr>
                    <td class="label">Tape Splices</td>
                    <td class="value">{{ $data->tape_splices }}</td>
                </tr>

                <tr>
                    <td class="label">Restored Tape Splices</td>
                    <td class="value">{{ $data->restored_ts }}</td>
                </tr>

                <tr>
                    <td class="label">Restored Perforations</td>
                    <td class="value">{{ $data->restored_perforations }}</td>
                </tr>

                <tr>
                    <td class="label">Restored Frames</td>
                    <td class="value">{{ $data->restored_frames }}</td>
                </tr>
