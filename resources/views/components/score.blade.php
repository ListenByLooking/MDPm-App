<div id="Score_modal" class="modal fade flip" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <form method="POST" route="{{ route('dpo.score') }}" id="score_form">
            ...
            <div class="modal-body">
                <div class="col-12">
                    <div class="form-group mb-2">
                        ...
                        <textarea class="form-control d-none" name="score_value" id="ckeditor-classic" required></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer border border-top pt-2 pb-2">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="score_button" onclick="javascript:dpo.score()">Save Changes</button>
            </div>
        </div><!-- /.modal-content -->
        </form>
    </div><!-- /.modal-dialog -->
