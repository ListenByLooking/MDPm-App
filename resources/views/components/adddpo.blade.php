                    ...
                    <div class="row">
                        <div class="col-12 bg-success-subtle">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="1901" step="1" placeholder="1970" id="dpo_year" class="form-control" name="dpo_year" required />
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 bg-success-subtle">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="dpo_venue" placeholder="Teatro Comunale G. Verdi" class="form-control" name="dpo_venue" required />
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 bg-success-subtle">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" id="dpo_city" placeholder="Padova" class="form-control" name="dpo_city" required />
                            </div>
